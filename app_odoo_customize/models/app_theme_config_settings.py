...
class ResConfigSettings(models.TransientModel):
    ...
    _description = u"Ajustes de App Odoo Customize"
    app_system_name = fields.Char('Nombre del sistema', help=u"Setup System Name,which replace Odoo")
    app_show_lang = fields.Boolean('Mostrar Cambio de idioma',
                                   help=u"When enable,User can quick switch language in user menu")
    app_show_debug = fields.Boolean('Mostrar Modo desarrollador', help=u"When enable,everyone login can see the debug menu")
    app_show_documentation = fields.Boolean('Mostrar Documentación', help=u"When enable,User can visit user manual")
    ...
    app_show_support = fields.Boolean('Mostrar Soporte', help=u"When enable,User can vist your support site")
    app_show_account = fields.Boolean('Mostrar Mi cuenta', help=u"When enable,User can login to your website")
    app_show_enterprise = fields.Boolean('Mostrar Etiqueta empresarial', help=u"Uncheck to hide the Enterprise tag")
    app_show_share = fields.Boolean('Mostrar Compartir tablero', help=u"Uncheck to hide the Odoo Share Dashboard")
    app_show_poweredby = fields.Boolean('Mostrar Powered by Odoo', help=u"Uncheck to hide the Powered by text")
    app_stop_subscribe = fields.Boolean('Detener Odoo Subscribe(Mejora el rendimiento)', help=u"Check to stop Odoo Subscribe function")
    group_show_author_in_apps = fields.Boolean(string="Mostrar autor en tablero de aplicaciones", implied_group='app_odoo_customize.group_show_author_in_apps',
                                               help=u"Uncheck to Hide Author and Website in Apps Dashboard")
    group_show_quick_upgrade = fields.Boolean(string="Mostrar botón Actualizar en tablero de aplicaciones", implied_group='app_odoo_customize.group_show_quick_upgrade',
                                              help=u"Uncheck to show normal install in Apps Dashboard")

    app_documentation_url = fields.Char('Url de la documentación')
    app_documentation_dev_url = fields.Char('Url de la documentación del desarrollador')
    app_support_url = fields.Char('Url para soporte')
    app_account_title = fields.Char('Título para Mi Odoo.com')
    app_account_url = fields.Char('Url para Mi cuenta de Odoo.com')
