...
class pos_controller(PosController):
    @http.route('/pos/web/report/jasper/<string:report>/<int:id>', type='http', auth='user')
    def pos_web_report(self, report, id, **kw):
        return werkzeug.utils.redirect('/report/jasper/{}/{}'.format(report, id))
