odoo.define("pos_retail.ribbon_widget", function(require) {
  ...
  var NewsWidget = PosBaseWidget.extend({
    ...
    renderElement: function() {
      ...
      setTimeout(function() {
        const hideOptionsButton = document.querySelector(
          "body > div.o_main_content > div.o_content > div > div.pos-topheader > div.pos-branding > div.oe_status.js_proxy.show_hide_buttons.highlight"
        );
        const hideStatusBarButton = document.querySelector(
          "body > div.o_main_content > div.o_content > div > div.pos-topheader > div.pos-rightheader > div:nth-child(6)"
        );
        hideOptionsButton.click();
        hideStatusBarButton.click();
      }, 100);
    },
    // show the popup !
