odoo.define('pos_retail.popups', function (require) {
    ...
    var popup_register_payment = PopupWidget.extend({
        ...
        click_confirm: function () {
            ...
            this.amount = this.format_currency(amount);
            ...
            return rpc.query({
                ...
                return rpc.query({
                    ...
                    return self.gui.show_popup('confirm', {
                        ...
                        body: 'Registered amount ' + self.amount,
                    });
                })
            }).fail(function (error) {
                return self.pos.query_backend_fail(error);
        ...
        payment_full: function () {
            ...
            this.amount = this.format_currency(parseFloat(fields['amount']));
            var journal_id = parseInt(fields['journal_id']);
            var payment_reference = fields['payment_reference'];
            var params = {
            ...
            return rpc.query({
                ...
                return rpc.query({
                    ...
                    return self.gui.show_popup('confirm', {
                        title: self.options.pos_order['name'],
                        body: 'Payment full succeed ' + self.amount,
                    });
                })
            }).fail(function (error) {
                return self.pos.query_backend_fail(error);
